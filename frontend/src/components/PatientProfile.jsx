      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {errors.fecha_nacimiento && <p className="text-red-600 text-sm mt-1">{errors.fecha_nacimiento}</p>}
          </div>
          ...
          {/* Estado */}
          <div>
            <label className={`${Size.MEDIUM} text-gray-700 block mb-2`}>Estado (No editable):</label>
            <p className={`${Size.MEDIUM} text-gray-600 bg-gray-100 px-4 py-2 rounded`}>{formData.estado}</p>
          </div>
        ...
        {isEditing && (
          <div className="flex gap-4 mt-6">
            ...
            <button
              ...
              className="flex-1 bg-gray-400 text-white py-3 rounded-lg hover:bg-gray-500 font-semibold flex items-center justify-center gap-2"
            >
              <MdClose /> Cancelar
            </button>
          </div>
