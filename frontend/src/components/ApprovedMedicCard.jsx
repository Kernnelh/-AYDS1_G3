...
export const ApprovedMedicCard = ({ medico, onDeactivate, onUpdate }) => {
  const [showDeactivateModal, setShowDeactivateModal] = useState(false);
  const [showEditModal, setShowEditModal] = useState(false);
  const [razonBaja, setRazonBaja] = useState('');
  const [editData, setEditData] = useState(medico);
  ...
  const handleDeactivate = async () => {
    ...
    setLoading(true);
    try {
      await onDeactivate(medico.id_medico, razonBaja);
  ...
  const handleUpdate = async () => {
    setLoading(true);
    try {
      await onUpdate(medico.id_medico, editData);
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4 text-xs">
            ...
            <div className="col-span-2">
              ...
              <p className="text-gray-700">{medico.numero_colegiado || medico.no_colegiado}</p>
            </div>
          </div>
          ...
          >
            ...
            >
              <h3 className={`${Size.LARGE} font-bold text-gray-800 mb-4`}>
                Dar de Baja a Dr(a). {medico.nombre}
              </h3>
              <textarea
                value={razonBaja}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleEditChange('especialidad', e.target.value)}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editData.numero_colegiado || editData.no_colegiado || ''}
                    onChange={(e) => handleEditChange('numero_colegiado', e.target.value)}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                </div>
