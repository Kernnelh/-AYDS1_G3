...
export const ReportDoctor = ({ appointment, onClose, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onSuccess('Reporte enviado al administrador exitosamente.');
      onClose();
    } catch {
        ...
        >
          ...
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className={`${Size.LARGE} font-bold text-gray-800`}>
                Reportar al Dr. {appointment.medico}
              </h3>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Describe con detalle el motivo de tu reporte (mínimo 20 caracteres)..."
              rows={4}
          ...
          {error && (
            <p className={`${Size.MEDIUM} text-red-600 mb-3`}>{error}</p>
          )}
